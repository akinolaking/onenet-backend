...
<div id="order-standard_cart" class="hostx-cart-body-section">
    ...
    <div class="row domain-renewal-page">
        <div class="cart-body">
                ...
                <div class="row">
                            ...
                            {foreach $renewalsData as $renewalData}
                                <div class="domain-renewal" data-domain="{$renewalData.domain}">
                                    ...
                                    <div class="text-left">
                                        ...
                                        {else}
                                            <button id="renewDomain{$renewalData.id}" class="btn button-style hx-secondary btn-add-renewal-to-cart" data-domain-id="{$renewalData.id}">
                                                <span class="to-add">
                    ...
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        ...
                        <div id="orderSummary">
                            ...
                            <div class="text-center">
                                <a id="btnGoToCart" class="btn button-style hx-primary-btn" href="{$WEB_ROOT}/cart.php?a=view">
                                    {lang key='viewcart'}
