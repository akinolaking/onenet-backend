...
<div id="order-standard_cart" class="hostx-cart-body-section">
    ...
    <div class="row transfer-domain-page">
        <div class="cart-body">
                            ...
                            <div class="panel-body card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button type="submit" id="btnTransferDomain" class="btn button-style hx-primary-btn btn-transfer{$captcha->getButtonClass($captchaForm)}">
