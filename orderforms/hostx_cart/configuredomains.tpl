...
<div id="order-standard_cart" class="hostx-cart-body-section">
    ...
    <div class="configure-domain-page">
        <div class="cart-body">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=confdomains" id="frmConfigureDomains">
                ...
                <div class="domain-configure-hostx">
                    <div class="domain-config-data-sec">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <p class="domain-period">{$domain.regperiod} {$LANG.orderyears}</p>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            {if $domain.dnsmanagement}
                                <div class="col-sm-{math equation="12 / numAddons" numAddons=$domain.addonsCount} mb-3">
                                    <div class="panel panel-default panel-addon{if $domain.dnsmanagementselected} panel-addon-selected{/if}">
                                        ...
                                        <div class="panel-add button-style hx-primary-btn">
                    ...
                    {/if}
                    {if count($domain.fields) gt 0}
                        <div class="row domain-custon-field-area">
                            {foreach from=$domain.fields key=domainfieldname item=domainfield}
                                <div class="form-group col-md-6">
                                    <label class="cus-field-lable-domain">{$domainfieldname}:</label>
                                    {$domainfield}
                                </div>
                            {/foreach}
                        </div>
