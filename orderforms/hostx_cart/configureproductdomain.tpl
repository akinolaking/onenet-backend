                    ...
                    {if $registerdomainenabled}
                        <div class="option">
                            ...
                            <div class="domain-input-group clearfix{if $showAdvancedSearchOptions} domain-checker-advanced{/if}" id="domainregister">
                                <div class="row">
                                    <div class="{if $showAdvancedSearchOptions}col-sm-9{else}col-sm-10{/if}">
                                    ...
                                    <div class="{if $showAdvancedSearchOptions}col-sm-3{else}col-sm-2{/if}">
                                        <button id="btnCheckAvailability" type="submit" class="btn button-style hx-primary-btn">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="row domains-row">
                                            ...
                                            <label class="product-safesearch-label">
