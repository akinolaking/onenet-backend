            ...
            <div class="domain-pricing">
                {if $featuredTlds}
                    <div class="featured-tlds-container">
                        <div class="{if count($featuredTlds) > 4}spot-tld-slider-area{else}row{/if}">
                            {foreach $featuredTlds as $num => $tldinfo}
                                <div class="{if count($featuredTlds) > 4}slider-item-spotlight{else}col-lg-3{/if}">
                ...
                <div class="row">
                    <div class="{if $domainTransferEnabled}col-md-6{else}col-md-8 col-md-offset-2 offset-md-2{/if}">
                        <div class="domain-promo-box">
                            ...
                            <a href="{$WEB_ROOT}/cart.php" class="btn button-style hx-primary-btn">
                    ...
                    {if $domainTransferEnabled}
                        <div class="col-md-6">
                            <div class="domain-promo-box">
                                ...
                                <a href="{$WEB_ROOT}/cart.php?a=add&domain=transfer" class="btn button-style hx-black-btn">
