                ...
                <input type="hidden" name="i" value="{$i}" />
                    <div class="row">
                        <div class="secondary-cart-body">
                            <div class="heading-area-configuration">
                                <div class="header-lined-descp">
                            ...
                            {if $customfields}
                                <div class="custom-field-configure-product">
                        ...
                        <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                            <div id="orderSummary">
                                ...
                                <div class="text-center">
                                    <button type="submit" id="btnCompleteProductConfig" class="btn button-style hx-primary-btn">
                                        {$LANG.continue}
