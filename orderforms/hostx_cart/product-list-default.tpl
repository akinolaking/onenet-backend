  <div class="row default-listing-products-cart">
      <div class="cart-body">
                              ...
                              <div class="product-pricing" id="{$idPrefix}-price">
                                  ...
                                  {else}
                                      ...
                                      {if $hasStrikedData && $hasStrikedData.{$product.pid}.rawStriked gt 0}
                                            <div class="whmcs-default-pricing-discount-sec">
                                                {if $hasStrikedData.{$product.pid}.strikedType eq '0'}
                                                    <small class="saveamounts">{$LANG.discount_save_badge} {$hasStrikedData.{$product.pid}.strikedAmount}%</small>
                                                {elseif $hasStrikedData.{$product.pid}.strikedType eq '1'}
                                                    <small class="saveamounts">{$LANG.discount_flat_badge} {$hasStrikedData.{$product.pid}.strikedAmount} {$LANG.discount_flat_off_badge}</small>
                                                {/if}
