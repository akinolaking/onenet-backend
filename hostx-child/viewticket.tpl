        ...
        <div class="card-body p-3">
            <h3 class="card-title">
                ...
                <div class="ticket-actions float-sm-right mt-3 mt-sm-0">
                    <button id="ticketReply" type="button" class="btn button-style hx-primary-btn" onclick="smoothScroll('#ticketReplyContainer')">
                        <i class="fas fa-pencil-alt fa-fw"></i>
                        {lang key='supportticketsreply'}
                    </button>
                    {if $showCloseButton}
                        {if $closedticket}
                            <button class="btn button-style hx-black-btn" disabled="disabled">
                                <i class="fas fa-times fa-fw"></i>
                                {lang key='supportticketsstatusclosed'}
                            </button>
                        {else}
                            <button class="btn button-style hx-black-btn" onclick="window.location='?tid={$tid}&amp;c={$c}&amp;closeticket=true&amp;token={$token}'">
                                <i class="fas fa-times fa-fw"></i>
        ...
        <div class="card-body">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?tid={$tid}&amp;c={$c}&amp;postreply=true" enctype="multipart/form-data" role="form" id="frmReply">
                ...
                <div class="form-group text-center">
                    <input class="btn button-style hx-primary-btn" type="submit" name="save" value="{lang key='supportticketsticketsubmit'}" />
                    <input class="btn button-style hx-black-btn" type="reset" value="{lang key='cancel'}" onclick="jQuery('#ticketReply').click()" />
                </div>
            </form>
