            ...
            <div class="row">
                <div class="col-sm-7">
                    {if !empty($hostx_theme_settings.invoice_logo)}
                        <img src="{$hostx_theme_settings.invoice_logo}" class="logo-quote-view" {if $hostx_theme_settings.invoice_logo_height neq ''} height="{$hostx_theme_settings.invoice_logo_height}" {/if} {if $hostx_theme_settings.invoice_logo_width neq ''} width="{$hostx_theme_settings.invoice_logo_width}"{/if}>
                    {else}
                        {if $logo}
