<header class="header wgs-new-header-top">
    <div class="container">
        {if !empty($hostx_theme_settings.header_logo)}
                <a href="{if $hostx_theme_settings.header_logo_link neq ''}{$hostx_theme_settings.header_logo_link}{else}{$systemurl}{/if}" {if $hostx_theme_settings.enable_header_target eq 'on'}target="_blank"{/if}  class="logo wgs-new-head-logo">
        ...
        {else}
                <a href="{if $hostx_theme_settings.header_logo_link neq ''}{$hostx_theme_settings.header_logo_link}{else}{$systemurl}{/if}" class="logo logo-text wgs-new-head-logo" {if $hostx_theme_settings.enable_header_target eq 'on'}target="_blank"{/if}>{$companyname}</a>
        {/if}	
        <div class="right float-right">
            <ul class="nav right_navi"> 
                    ...
                    {else}
                        <li class="hover mblshow"><a href="{$WEB_ROOT}/clientarea.php"><i class="fa fa-user"></i></a></li>
                        <li class="hover mblshow user-logout-list"><a href="{$WEB_ROOT}/logout.php"><i class="fa fa-sign-out"></i></a></li>
                    {/if}
