<div class="card hostx-bulk-domain-page">
    <div class="card-body">
        <form method="post" action="{$smarty.server.PHP_SELF}?action=bulkdomain">
            ...
            {if $update eq "nameservers"}
                ...
                <ul class="list-group mb-3 domain-list-blk">
                ...
                {for $num=1 to 5}
                    <div class="form-group row">
                        <label for="inputNs{$num}" class="col-sm-2 col-form-label">{lang key='clientareanameserver'} {$num}</label>
                        <div class="col-sm-7">
            ...
            {elseif $update eq "autorenew"}
                ...
                <button type="submit" name="enable" class="button-style hx-primary-btn">
                    {lang key='domainsautorenewenable'}
                </button>
                <button type="submit" name="disable" class="button-style btn-danger">
            ...
            {elseif $update eq "reglock"}
                ...
                <button type="submit" name="disable" class="button-style hx-secondary">
...
<a href="clientarea.php?action=domains" class="button-style hx-secondary">
