...
<div class="landing-page bg-white threesixtymonitoring">
    <section class="section-header landing-page hero ssl">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <!-- <img class="img-logo" src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/logo.png"> -->
                    <img class="d-lg-none img-full" src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/header-screens.png">
                    ...
                    <div class="tab-website">
                        ...
                        <form action="{routePath('cart-threesixtymonitoring-site-check')}" id="frmSiteCheck">
                            <div class="form-row">
                                ...
                                <div class="col-2">
                                    <button type="submit" class="btn btn-search hx-primary-btn">
                                        search
                    ...
                    <div class="tab-server"{if $websitePlanCount > 0} style="display: none;"{/if}>
                        ...
                        <p class="new-tagline">{lang key="store.threesixtymonitoring.serverHeading.tagline"}</p>
                        <a href="#serverSectionPricing" class="btn button-style hx-primary-btn">{lang key="store.threesixtymonitoring.button.getStarted"}</a>
                    </div>
                    {/if}
                </div>
                <div class="col-6 d-none d-lg-block threesixty-monitoring-right">
                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/header-screens.png">
                </div>
            </div>
        </div>
    </section>
...
<!-- <div class="landing-page bg-white ssl">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="hero-right-img">
                        <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/hero-img-ssl.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="nav-primary site-monitoring-sec">
        <div class="container">
    ...
    <div class="tab-content website-monitoring">
        <div class="tab-pane tab-website fade{if $websitePlanCount > 0} show active{/if}" id="pills-website" role="tabpanel" aria-labelledby="pills-website-tab">
            <section class="section-discover">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="site-mointoring-left">
                                <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/screen-full-site.png">
                            </div>
                        </div>
                        <div class="site-mointoring-right col-md-6">
                    ...
                    <div class="row-features">
                            <div class="row-features-inner">
                                <div class="row-features-left">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0008_icon.png">
                                </div>
                            ...
                            <div class="row-features-inner">
                                <div class="row-features-left">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0007_icon.png">
                                </div>
                                <div class="row-features-right">
                            ...
                            <div class="row-features-inner">
                                <div class="row-features-left">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0006_icon.png">
                                </div>
                                <div class="row-features-right">
                    ...
                    <a href="#websiteSectionPricing" class="btn button-style hx-primary-btn">{lang key="store.threesixtymonitoring.button.startMonitoringLong"}</a>
                </div>
                </div>
            </div>
            </section>
                        ...
                        <div class="container tab-pane fade show active" id="features-website" role="tabpanel" aria-labelledby="features-website-tab">
                            <div class="row row-features">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0005_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0004_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0003_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0002_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0001_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0000_icon.png">
                                        </div>
                                        <div class="col-12">
                            ...
                            <a href="#websiteSectionPricing" class="btn button-style hx-primary-btn">{lang key="store.threesixtymonitoring.button.getStarted"}</a>
                        </div>
                        <div class="container tab-pane fade" id="features-server" role="tabpanel" aria-labelledby="features-server-tab">
                            <div class="row row-features">
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0012_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0011_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0010_icon.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/website_0009_icon.png">
                                        </div>
                                        <div class="col-12">
            ...
            <section class="section-notifications p-vertical">
                <div class="container">
                    ...
                    <div class="row row-notifications">
                        <div class="col-12 col-lg-6">
                            <div class="row">
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0012_mail.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0011_sms.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0008_push.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0009_gch.png">
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="row">
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0010_pb.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0013_discord.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0007_slack.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0006_webhook.png">
                                        </div>
                                        <div class="col-12">
                            ...
                            <div class="row bottom-row">
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0005_stride.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0004_pager.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0003_tg.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 d-lg-none">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0002_flock.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 offset-3 offset-lg-0">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0001_ms.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/app_0000_genie.png">
                                        </div>
                                        <div class="col-12">
            ...
            <section class="section-monitoring p-vertical">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <h2>{lang key="store.threesixtymonitoring.websiteMonitor.title"}</h2>
                            <img class="d-block d-lg-none img-full" src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/screen-status.png">
                            <p class="p-tagline">{lang key="store.threesixtymonitoring.websiteMonitor.tagline"}</p>
                            <a href="#websiteSectionPricing" class="btn button-style hx-primary-btn">{lang key="store.threesixtymonitoring.button.startMonitoringShort"}</a>
                        </div>
                        <div class="col-6 d-none d-lg-block">
                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/screen-status.png">
                        </div>
                    </div>
                </div>
            </section>

            <section id="websiteSectionPricing" class="section-pricing p-vertical">
                {if $websitePlanCount > 0}
                <div class="container">
                            ...
                            <div class="div-feature-values feature-count-{$websitePlanCount}">
                                ...
                                <div class="div-feature-order">
                                    <form method="post" action="{routePath('cart-order')}">
                                        ...
                                        <button class="btn button-style hx-primary-btn" type="submit"{if $inPreview} disabled="disabled"{/if}>
                                            {lang key="ordertitle"}
                                        </button>
                                    </form>
                                </div>
            ...
            <section class="section-faq p-vertical">
                <div class="container">
        ...
        <div class="tab-pane tab-server fade{if $websitePlanCount <= 0} show active{/if}" id="pills-server" role="tabpanel" aria-labelledby="pills-server-tab">
            <section class="section-discover">
                <div class="container">
                    <div class="div-heading-container">
                        <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/screen-dash.png">
                        <div class="div-heading-text">
                            <h2>{lang key="store.threesixtymonitoring.websiteDiscover.title"}</h2>
                    ...
                    <div class="row row-features">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/server_0001_icon.png">
                                </div>
                                <div class="col-12">
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/server_0000_icon.png">
                                </div>
                                <div class="col-12">
                ...
                <div class="container">
                    ...
                    <div class="row row-features">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/server_0002_icon.png">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i7a"}</span>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/server_0003_icon.png">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i8a"}</span>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 offset-md-3 offset-lg-0">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/server_0004_icon.png">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i9a"}</span>
                                </div>
    ...
    <div class="modal modal-results fade" id="modalTestResults" tabindex="-1" role="dialog" aria-labelledby="modalTestResultsTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background-image: url('{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/modal-bg.png')">
