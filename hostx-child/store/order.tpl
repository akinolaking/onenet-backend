...
<div class="container">
    <div class="store-order-inner p-vertical">
        ...
        <form method="post" action="{routePath('cart-order-addtocart')}" id="frmAddToCart">
                ...
                {if $requireDomain}
                    {if (count($domains) > 0 && $loggedin)}
                        <li class="nav-item active" role="presentation">
                            <a class="nav-link p-3" href="#existing-domain" aria-controls="existing-domain" role="tab" data-toggle="tab">
                    ...
                    {if $allowSubdomains}
                        <li class="nav-item" role="presentation">
                            <a class="nav-link p-3" href="#sub-domain" aria-controls="sub-domain" role="tab" data-toggle="tab">
                                {lang key='store.subOfExisting'}
                            </a>
                        </li>
                    {/if}
                    <li class="nav-item" role="presentation">
                        <a class="nav-link p-3" id="tabCustomDomainControl" href="#custom-domain" aria-controls="custom-domain" role="tab" data-toggle="tab">
                            {lang key='store.domainAlreadyOwned'}
                        </a>
                    </li>
                {else}
                    <li class="nav-item" role="presentation" class="active">
                        <a class="nav-link p-3" id="tabNoDomain" href="#no-domain" role="tab" data-toggle="tab">
            ...
            <div class="row">
                <div class="col-sm-5">
                     <a href="javascript:history.go(-1)" class="btn btn-default btn-primary button-style hx-secondary">
                        <i class="fas fa-arrow-left"></i>
                        {lang key='back'}
                    </a>
                </div>
                <div class="col-sm-7 text-right">
                    <button type="submit" name="continue" value="1" class="btn btn-default button-style hx-primary-btn">
                        {lang key='orderForm.continueShopping'}
                    </button>
                    <button type="submit" name="checkout" value="1" class="btn btn-primary button-style hx-secondary">
    ...
    {if $upsellProduct && $promotion}
        <div class="card mt-5">
            <div class="card-body p-3 store-promoted-product upsell-{$upsellProduct->productKey}">
                <div class="row">
                    <div class="col-md-3">
                        <div class="icon">
                    ...
                    <div class="col-md-9">
                        ...
                        <form method="post" action="{routePath('cart-order')}">
                            ...
                            <button type="submit" class="btn button-style hx-secondary">
                                {foreach $product->pricing()->allAvailableCycles() as $pricing}
