        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <img class="d-lg-none img-full" src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/header-screens.png">
                ...
                <div class="col-6 d-none d-lg-block threesixty-monitoring-right">
                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/header-screens.png">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="site-mointoring-left">
                                <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/screen-full-site.png">
                            </div>
                        </div>
                        ...
                        <div class="container tab-pane fade" id="features-server" role="tabpanel" aria-labelledby="features-server-tab">
                            <div class="row row-features">
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/identify-broken.svg" alt="identify-broken">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/detect-missing.svg" alt="detect">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/performance-impact.svg" alt="performance">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/google-font.svg" alt="font-icon">
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="row">
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0012_mail.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0011_sms.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0008_push.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0009_gch.png">
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="row">
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0010_pb.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0013_discord.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0007_slack.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 fav-icon">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0006_webhook.png">
                                        </div>
                                        <div class="col-12">
                            ...
                            <div class="row bottom-row">
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0005_stride.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0004_pager.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0003_tg.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 d-lg-none">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0002_flock.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3 offset-3 offset-lg-0">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0001_ms.png">
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-12 col-brand-img">
                                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/app_0000_genie.png">
                                        </div>
                                        <div class="col-12">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <img class="d-block d-lg-none img-full" src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/screen-status.png">
                        ...
                        <div class="col-6 d-none d-lg-block">
                            <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/screen-status.png">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="tab-pane tab-server fade{if $websitePlanCount <= 0} show active{/if}" id="pills-server" role="tabpanel" aria-labelledby="pills-server-tab">
            ...
            <section class="section-monitoring">
                <div class="container">
                    ...
                    <a href="#serverSectionPricing" class="btn button-style hx-primary-btn ">{lang key="store.threesixtymonitoring.button.startMonitoringShort"}</a>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row row-features">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/identify-broken.svg">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i7a"}</span>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/detect-missing.svg">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i8a"}</span>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 offset-md-3 offset-lg-0">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{$WEB_ROOT}/templates/{$template}/marketconnect/threesixtymonitoring/{$layoutStyle}/performance-impact.svg">
                                </div>
                                <div class="col-12">
                                    <span>{lang key="store.threesixtymonitoring.websiteFeatures.i9a"}</span>
                                </div>
