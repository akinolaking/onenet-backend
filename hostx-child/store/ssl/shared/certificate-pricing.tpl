<div class="p-vertical  certificate-options {$type}">
    <div class="container">

        <h2>{lang key='store.ssl.shared.pricing'}</h2>
        ...
        <div class="row">
            ...
            <div class="{if count($certificates.$type) == 1}col-lg-6 offset-lg-3 col-md-12 {elseif count($certificates.$type) == 2}col-md-12 {else}col-sm-12{/if}">
                <div class="row row-pricing-table">
                    ...
                    {if count($certificates.$type) > 0}
                        {foreach $certificates.$type as $product}
                            <div class=" rapid-ssl-sec col-md-{if count($certificates.$type) == 1}6{elseif count($certificates.$type) == 2}4{else}3{/if}">
                                ...
                                <form method="post" action="{routePath('cart-order')}">
                                    ...
                                    <button type="submit" class="btn btn-block button-style hx-primary-btn">{lang key='store.ssl.landingPage.buyNow'}</button>
                                </form>
                            </div>
                            </div>
                        {/foreach}
                ...
                <br>
                <div class="row">
                    <div class="{if count($certificates.$type) == 1}col-sm-12{elseif count($certificates.$type) == 2}col-md-12 {else}col-md-12{/if} text-center">
