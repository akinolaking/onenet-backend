...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="{routePath('user-profile-save')}">
            ...
            <input class="btn button-style hx-primary-btn" id="btnSaveNameChanges" type="submit" name="save" value="{lang key='clientareasavechanges'}" />
            <input class="btn button-style hx-black-btn" type="reset" value="{lang key='cancel'}" />
        </form>
