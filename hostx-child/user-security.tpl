    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{routePath('user-security-question')}">
                ...
                <p>
                    <input class="btn hx-primary-btn" type="submit" name="submit" value="{lang key='clientareasavechanges'}" />
                    <input class="btn hx-secondary" type="reset" value="{lang key='cancel'}" />
                </p>
            </form>
        </div>
    </div>
...
{if $twoFactorAuthAvailable}
    <div class="card">
        <div class="card-body">
            ...
            <a href="{routePath('account-security-two-factor-enable')}" class="btn hx-primary-btn open-modal twofa-config-link enable{if $twoFactorAuthEnabled} w-hidden{/if}" data-modal-title="{lang key='twofaenable'}" data-modal-class="twofa-setup" data-btn-submit-id="btnEnable2FA">
