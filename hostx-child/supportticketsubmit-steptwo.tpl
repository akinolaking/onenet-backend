...
<div class="card">
    <div class="card-body extra-padding">
        ...
        <p class="text-center">
            <button type="submit" id="openTicketSubmit" class="btn button-style hx-primary-btn disable-on-click{$captcha->getButtonClass($captchaForm)}">
                {lang key='supportticketsticketsubmit'}
            </button>
            <a href="supporttickets.php" class="btn button-style hx-secondary">{lang key='cancel'}</a>
        </p>
