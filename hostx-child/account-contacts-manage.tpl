    ...
    <form role="form" method="post" action="{routePath('account-contacts')}">
        <div class="row">
            ...
            <div class="col-md-2 mt-2 mt-md-0">
                <button type="submit" class="button-style hx-primary-btn">{lang key='go'}</button>
            </div>
        </div>
    </form>
</div>
...
<div class="card">
    ...
    <div class="form-group text-center">
        <input class="button-style hx-primary-btn" type="submit" name="save" value="{lang key='clientareasavechanges'}" />
        <input class="button-style hx-secondary" type="reset" value="{lang key='cancel'}" />
        <button type="button" class="btn button-style hx-black-btn" data-toggle="modal" data-target="#modalDeleteContact">{lang key='clientareadeletecontact'}</button>
    </div>
