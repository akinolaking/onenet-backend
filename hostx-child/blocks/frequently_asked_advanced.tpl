                          ...
                          <div class="card">
                            <div class="card-header" role="tab" id="headingTwo{$key}">
                              <a class="collapsed card-anchor" data-toggle="collapse" data-parent="#accordionEx1" 
                                ...
                                <h5 class="mb-0">{eval var=$widget->widget_title|html_entity_decode}</h5>
                              </a>
                            </div>
            ...
            <h2>{$LANG.sslPageFaqHead}</h2>
              <div class="col-sm-12">
               <div class="accordion-container-main">
                     <div class="accordion md-accordion" id="accordionEx1" role="tablist" aria-multiselectable="true">
                          <div class="card">
                            <div class="card-header" role="tab" id="headingTwo0">
                              <a class="card-anchor collapsed" data-toggle="collapse" data-parent="#accordionEx1" aria-expanded="false" aria-controls="collapseTwo1">
                                <h5 class="mb-0">{$LANG.sslPageFaqAccord1Head}</h5>
                              </a>
                            </div>
                            <div id="collapse0" class="collapse card-body-new" role="tabpanel" aria-labelledby="headingTwo0" data-parent="#accordionEx1" style="display: none;">
                          ...
                          <div class="card">
                            ...
                            <div id="collapse1" class="collapse card-body-new" role="tabpanel" aria-labelledby="headingTwo1" data-parent="#accordionEx1" style="display: none;">
                              <div class="card-body">{$LANG.sslPageFaqAccord2Body}</div>
                            </div>
                          </div>
                          <div class="card">
                            <div class="card-header" role="tab" id="headingTwo2">
                              <a class="collapsed card-anchor" data-toggle="collapse" data-parent="#accordionEx1" aria-expanded="false" aria-controls="collapseTwo1">
                                <h5 class="mb-0">{$LANG.sslPageFaqAccord3Head}</h5>
                              </a>
                            </div>
                            <div id="collapse2" class="collapse card-body-new" role="tabpanel" aria-labelledby="headingTwo2" data-parent="#accordionEx1">
                          ...
                          <div class="card">
                            ...
                            <div id="collapse3" class="collapse card-body-new" role="tabpanel" aria-labelledby="headingTwo3" data-parent="#accordionEx1">
                          ...
                          <div class="card">
                            ...
                            <div id="collapse4" class="collapse card-body-new" role="tabpanel" aria-labelledby="headingTwo4" data-parent="#accordionEx1">
