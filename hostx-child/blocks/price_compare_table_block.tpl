{if $hostx_blocks[$block_slug]}
   <div class="tabs-sec p-vertical {if $hostx_theme_settings.enable_sticky_header eq 'on'}tabs-sticky{/if}">
   ...
   <div class="container compare-table-section">
      <ul class="nav nav-tabs" role="tablist">
         <li class="nav-item active">
            <a class="nav-link compare-list-tab active" data-toggle="tab" href="#featureTabBlock">Features</a>
         </li>
         <li class="nav-item">
            <a class="nav-link compare-list-tab" data-toggle="tab" href="#compareTabBlock">Compare</a>
         </li>
         <li class="nav-item">
            <a class="nav-link compare-list-tab" data-toggle="tab" href="#faqTabBlock">FAQ</a>
         </li>
      </ul>
      <div class="tab-content">
         <div id="featureTabBlock" class="container tab-pane active">
            <table>
               ...
               <tfoot class="thead-inverse">
                  <tr>
                     <th width="40%"></th>
                     <th><a href="#" class="compare-blk-btn button-style hx-secondary">Select</a></th>
                     <th><a  href="#" class="compare-blk-btn button-style hx-secondary">Select</a></th>
                     <th><a  href="#" class="compare-blk-btn button-style hx-secondary">Select</a></th>
                     <th></th>
                  </tr>
...
<script>
   jQuery(document).ready(function(){
      jQuery(document).on('click','.compare-list-tab',function(){
         jQuery('.compare-list-tab').parent().removeClass("active");
