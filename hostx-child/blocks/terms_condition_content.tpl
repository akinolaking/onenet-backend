...
<div class="inner-term-domain-page">
    <div class="container inner_term_container">
        {foreach $hostx_blocks[$block_slug]->widgets as $widget}
            {eval var=$widget->widget_title|html_entity_decode}
...
<div class="inner-term-domain-page">
   <div class="container inner_term_container">
      ...
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. </p>
      <ul class="term_lis">
         <li> <span><img src="{$WEB_ROOT}/templates/{$template}/images/chcek_price_icon.png" class="chcek_ic">
            Full Inbox protection at competitive prices</span>
         </li>
         <li><span><img src="{$WEB_ROOT}/templates/{$template}/images/chcek_price_icon.png" class="chcek_ic">
            Easy configuration </span>   
         </li>
         <li><span><img src="{$WEB_ROOT}/templates/{$template}/images/chcek_price_icon.png" class="chcek_ic">
            Various reporting options </span>
         </li>
         <li><span><img src="{$WEB_ROOT}/templates/{$template}/images/chcek_price_icon.png" class="chcek_ic">
            Increase employee productivity </span>  
         </li>
      </ul>
