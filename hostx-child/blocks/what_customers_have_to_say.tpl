<div class="customers p-vertical">
    <div class="container">
      <h2 class="text-center">{$LANG.domaincustomersay}</h2>
      <ul id="owl-demo" class="nav nav-pills">
        ...
        <li class="item nav-item active">    
          ...
          <h6>{$LANG.domaincustomername2}</h6> 
        ...
        <li class="item nav-item">    
          ...
          <h6>{$LANG.domaincustomername3}</h6> 
        ...
        <li class="item nav-item">    
          ...
          <h6>{$LANG.domaincustomername4}</h6> 
