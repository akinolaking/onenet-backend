{if $pageHaveProductData eq 'yes'}
  <div class="pricing_section pricing-block-vps-page-V1">
    <div class="container">
      <div class="tab-content">
        <div class="tab-pane container active" id="pricing">
            ...
            <div class="price_group {if $productsDataCount eq '1'}single-product-slider{elseif $productsDataCount eq '2'}double-product-slider{/if}">
              <div id="productList" class="hostx-pricing-block-vps-types {if $hostx_theme_settings.productlist_slide_setting eq '' || $hostx_theme_settings.productlist_slide_setting eq '3'}hostx-three-slide-active{elseif $hostx_theme_settings.productlist_slide_setting eq '4'}hostx-four-slide-active{/if}">
                      ...
                      <div class="price_sect {if $productsDataCount eq '1' || $productsDataCount eq '2'}price-select-single-double{/if}">
                        ...
                        {/if}
                          ...
                          {/if}
                            ...
                            {/if}
                          {if $productsDataCycles.onetime}
                            <a href="cart.php?a=add&pid={$productData.pid}" class="button03 blpr monthly button-style hx-primary-btn" {if $productsDataCycles.onetime}style="display: block;"{/if}>{$LANG.vps_order_now}</a>
                          {/if}
                          {if $productsDataCycles.free}
                            <a href="cart.php?a=add&pid={$productData.pid}" class="button03 blpr monthly button-style hx-primary-btn" {if $productsDataCycles.free}style="display: block;"{/if}>{$LANG.vps_order_now}</a>
                          {/if}
                          {if !$productsDataCycles.onetime || !$productsDataCycles.free}
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=monthly" class="button03 blpr monthly button-style hx-primary-btn" {if $productsDataCycles.monthly}style="display: block;"{/if}>{$LANG.vps_order_now}</a>  
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=quarterly" class="button03 blpr quarterly button-style hx-primary-btn" {if !$productsDataCycles.monthly && $productsDataCycles.quarterly}style="display: block;"{/if}>{$LANG.vps_order_now}</a>  
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=semiannually" class="button03 blpr semiannually button-style hx-primary-btn" {if !$productsDataCycles.monthly && !$productsDataCycles.quarterly && $productsDataCycles.semiannually}style="display: block;"{/if}>{$LANG.vps_order_now}</a>  
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=annually" class="button03 blpr annually button-style hx-primary-btn" {if !$productsDataCycles.monthly && !$productsDataCycles.quarterly && !$productsDataCycles.semiannually && $productsDataCycles.annually}style="display: block;"{/if}>{$LANG.vps_order_now}</a>
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=biennially" class="button03 blpr biennially button-style hx-primary-btn"{if !$productsDataCycles.monthly && !$productsDataCycles.quarterly && !$productsDataCycles.semiannually && !$productsDataCycles.annually && $productsDataCycles.biennially}style="display: block;"{/if}>{$LANG.vps_order_now}</a>
                            <a href="cart.php?a=add&pid={$productData.pid}&billingcycle=triennially" class="button03 blpr triennially button-style hx-primary-btn" {if !$productsDataCycles.monthly && !$productsDataCycles.quarterly && !$productsDataCycles.semiannually && !$productsDataCycles.annually && !$productsDataCycles.biennially && $productsDataCycles.triennially}style="display: block;"{/if}>{$LANG.vps_order_now}</a>
                          {/if} 						
                        </div>
                      </div>              
                  {/foreach}
