    ...
    <div class="card-body">
        ...
        <form id="frmManagePaymentMethod" class="frm-credit-card-input" role="form" method="post" action="{if $editMode}{routePath('account-paymentmethods-save', $payMethod->id)}{else}{routePath('account-paymentmethods-add')}{/if}">
            ...
            <div class="form-group row">
                <label for="inputPaymentMethodType" class="col-md-2 control-label">{lang key='paymentMethods.type'}</label>
                <div class="col-md-8">
            ...
            <div class="fieldgroup-auxfields{if $remoteUpdate} w-hidden{/if}">
                <div class="form-group row">
                    <label for="inputDescription" class="col-md-2 control-label">{lang key='paymentMethods.description'}</label>
                    <div class="col-md-5">
            ...
            <div class="fieldgroup-creditcard{if $editMode && !$payMethod->isCreditCard() || $paymentMethodType == 'bankacct' || $remoteUpdate} w-hidden{/if}">
                <div class="cc-details">
                    <div class="form-group row">
                        <label for="inputCardNumber" class="col-md-2 control-label">{lang key='creditcardcardnumber'}</label>
                        <div class="col-md-5">
                    ...
                    {if $startDateEnabled}
                        <div class="form-group row">
                            <label for="inputCardStart" class="col-md-2 control-label">{lang key='creditcardcardstart'}</label>
                            <div class="col-md-5">
                    ...
                    {/if}
                    <div class="form-group row">
                        <label for="inputCardExpiry" class="col-md-2 control-label">{lang key='creditcardcardexpires'}</label>
                        <div class="col-md-5">
                    ...
                    {if $issueNumberEnabled}
                        <div class="form-group row">
                            <label for="inputCardIssue" class="col-md-2 col-12 control-label">{lang key='creditcardcardissuenum'}</label>
                    ...
                    {if $creditCardCvcFieldEnabled}
                        <div class="form-group row">
                            <label for="inputCardCvc" class="col-md-2 col-12 control-label">{lang key='creditcardcvvnumber'}</label>
                            <div class="col-md-5">
                                <input type="tel" class="form-control input-inline" id="inputCardCvc" name="cardcvv" autocomplete="off">
                                <div class="clearfix"></div>
                                <span class="field-error-msg">{lang key='paymentMethodsManage.cvcNumberNotValid'}</span>
                            </div>
                            <button id="cvvWhereLink" type="button" class="btn btn-link col-md-4" data-toggle="popover" data-content="<img src='{$BASE_PATH_IMG}/ccv.gif' width='210'>">
            ...
            <div class="fieldgroup-bankaccount{if $remoteUpdate || ($editMode && $payMethod->isCreditCard()) || ($paymentMethodType != 'bankacct' && !$editMode)} w-hidden{/if}">
                <div class="form-group row">
                    <label for="inputBankAcctType" class="col-md-2 control-label">{lang key='paymentMethodsManage.accountType'}</label>
                    <div class="col-md-8">
                        <label class="form-check form-check-inline">
                ...
                <div class="form-group row">
                    <label for="inputBankAcctHolderName" class="col-md-2 control-label">{lang key='paymentMethodsManage.accountHolderName'}</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <label for="inputBankName" class="col-md-2 control-label">{lang key='paymentMethodsManage.bankName'}</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <label for="inputBankRoutingNum" class="col-md-2 control-label">{lang key='paymentMethodsManage.sortCodeRoutingNumber'}</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <label for="inputBankAcctNum" class="col-md-2 control-label">{lang key='paymentMethodsManage.accountNumber'}</label>
                    <div class="col-md-8">
            ...
            <div class="fieldgroup-auxfields{if $remoteUpdate} w-hidden{/if}">
                <div class="form-group row">
                    <label for="inputBillingAddress" class="col-md-2 col-12 control-label">{lang key='billingAddress'}</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row submit-container">
                    <div class="col-md-8 offset-sm-4">
                        <button type="submit" name="submit" id="btnSubmit" class="btn button-style hx-primary-btn">{lang key='clientareasavechanges'}</button>
                        <a href="{routePath('account-paymentmethods')}" class="button-style hx-secondary">{lang key='cancel'}</a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form id="billingContactForm" action="{routePath('account-paymentmethods-billing-contacts-create')}" data-role="json-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn button-style hx-secondary" data-dismiss="modal">{lang key='paymentMethods.close'}</button>
                    <button type="submit" class="btn button-style hx-primary-btn">{lang key='paymentMethods.saveChanges'}</button>
                </div>
            </form>
        </div>
    </div>
        ...
        jQuery('#billingContactForm')
            ...
            jQuery('input[name="type"]').on('ifChecked', function(e) {
                if(jQuery(this).data('gateway') == 'stripe'){
                    setTimeout(function() {
                        if(jQuery("#stripeElements").find("label").hasClass("col-sm-4")){
                            jQuery("#stripeElements").find("label").toggleClass("col-sm-4 col-sm-2"); 
                        }
					}, 1000);
                }
            });
