            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="inputGeneratePasswordLength" class="col-sm-12 col-form-label">{lang key='generatePassword.pwLength'}</label>
                        <div class="col-sm-12">
                            <input type="number" min="8" max="64" value="12" step="1" class="form-control input-inline input-inline-100" id="inputGeneratePasswordLength">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputGeneratePasswordOutput" class="col-sm-12 col-form-label">{lang key='generatePassword.generatedPw'}</label>
                        <div class="col-sm-12">
