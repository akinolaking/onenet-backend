<div{if !$addingNewCard} class="w-hidden"{/if}>
    <div class="form-group cc-details">
        <label for="inputCardNumber" class="payment-card-label text-md-right col-form-label">{lang key='creditcardcardnumber'}</label>
    ...
    {if $showccissuestart}
        <div class="form-group cc-details">
            <label for="inputCardStart" class="payment-card-label text-md-right col-form-label">{lang key='creditcardcardstart'}</label>
            <div class="payment-card-input">
    ...
    {/if}
    <div class="form-group cc-details">
        <label for="inputCardExpiry" class="payment-card-label text-md-right col-form-label">{lang key='creditcardcardexpires'}</label>
        <div class="payment-card-input">
    ...
    {if $showccissuestart}
        <div class="form-group cc-details">
            <label for="inputIssueNum" class="payment-card-label text-md-right col-form-label">{lang key='creditcardcardissuenum'}</label>
            <div class="payment-card-input">
...
<div class="form-group">
    <label for="inputCardCvv" class="payment-card-label text-md-right col-form-label">{lang key='creditcardcvvnumber'}</label>
    <div class="payment-card-input">
...
<div{if !$addingNewCard} class="w-hidden"{/if}>
    <div id="inputDescriptionContainer" class="form-group cc-details">
        <label for="inputDescription" class="payment-card-label text-md-right col-form-label">{lang key='paymentMethods.cardDescription'}</label>
        <div class="payment-card-input">
