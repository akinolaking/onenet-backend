...
<head>
    ...
    {* <link href="{$WEB_ROOT}/assets/css/fontawesome-all.min.css" rel="stylesheet">8.13 *}
    ...
    <link href="{assetPath file='invoice-hostx.css'}?v={$versionHash}" rel="stylesheet">
            ...
            <div class="row invoice-header">
                <div class="col-12 col-sm-6 justify-content-sm-between text-center text-sm-left invoice-col">
                    {if !empty($hostx_theme_settings.invoice_logo)}
                        <img src="{$hostx_theme_settings.invoice_logo}" class="logo-invoice-view" {if $hostx_theme_settings.invoice_logo_height neq ''} height="{$hostx_theme_settings.invoice_logo_height}" {/if} {if $hostx_theme_settings.invoice_logo_width neq ''} width="{$hostx_theme_settings.invoice_logo_width}"{/if}>
                    {else}
                        {if $logo}
